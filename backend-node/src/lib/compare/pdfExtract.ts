...
import { isPageNumber } from './contentFilter.js'
import type { PdfPageSize } from '../../types/compare.js'
import type { CharBBox, PdfExtractResult, TextBlock } from './types.js'
...
function cleanWatermarkText(
  ...
  const cleaned = stripLeadingNumericWatermark(stripped.text, stripped.charBboxes)
